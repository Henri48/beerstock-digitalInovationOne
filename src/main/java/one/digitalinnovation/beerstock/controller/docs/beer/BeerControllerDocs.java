package one.digitalinnovation.beerstock.controller.docs.beer;
...
public interface BeerControllerDocs {
    ...
    BeerDTO createBeer(BeerDTO beerDTO, Long idBrand) throws BeerAlreadyRegisteredException, BrandNotFoundException;
    ...
    List<BeerDTO> listBeers(Long idBrand);
